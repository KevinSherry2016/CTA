...
# 策略类型：趋势动量复合策略
# 策略名称：DualMAMomentum
# 代表意义：以双均线因子为趋势主逻辑，判断趋势大方向。动量因子为趋势辅助逻辑，判断小趋势或反转。结果映射到状态机[-1, -0.5, 0, 0.5, 1]
# 适用板块：Ferrous
# ==============================================================================
...
def main():
    ...
    if results:
        ...
        report_path = os.path.join(output_dir, "DualMAMomentum_Ferrous_BacktestResult.csv")
    ...
    if best_positions:
        ...
        pos_path = os.path.join(output_dir, f"DualMAMomentum_Position_Ferrous.csv")
