    ...
    tasks = [
        {
            ...
            'file_weights': {
                'MeanReversion_GapFillPressure_Agriculture_N30_TANH_norm_Position.csv': 1.0,
                'MeanReversion_ExhaustionReversalComposite_Agriculture_N70_TANH_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'L1_Sector_Energy',
            'file_weights': {
                'MeanReversion_VolumeShockReversal_Energy_N30_STATE_MACHINE_norm_Position.csv': 1.0,
                'MeanReversion_VolumeShockReversal_Energy_N80_STATE_MACHINE_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'L1_Sector_Ferrous',
            'file_weights': {
                'MeanReversion_GapFillPressure_Ferrous_N10_STATE_MACHINE_norm_Position.csv': 1.0,
                'MeanReversion_GapFillPressure_Ferrous_N80_STATE_MACHINE_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'L1_Sector_NonFerrous',
            'file_weights': {
                'MeanReversion_GapFillPressure_NonFerrous_N40_STATE_MACHINE_norm_Position.csv': 1.0,
                'MeanReversion_GapFillPressure_NonFerrous_N60_STATE_MACHINE_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'L1_Sector_Precious',
            'file_weights': {
                'MeanReversion_ExhaustionReversalComposite_Precious_N10_TANH_norm_Position.csv': 1.0,
                'MeanReversion_ExhaustionReversalComposite_Precious_N80_STATE_MACHINE_norm_Position.csv': 1.0,
            },
        },
        {
