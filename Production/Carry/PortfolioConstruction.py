...
def main():
    tasks = [
        {
            'output_name': 'CM_L1_Sector_Agriculture',
            'file_weights': {
                'Carry_Momentum_Agriculture_N10_STATE_MACHINE_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'CM_L1_Sector_Energy',
            'file_weights': {
                'Carry_Momentum_Energy_N10_STATE_MACHINE_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'CM_L1_Sector_Ferrous',
            'file_weights': {
                'Carry_Momentum_Ferrous_N60_STATE_MACHINE_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'CM_L1_Sector_NonFerrous',
            'file_weights': {
                'Carry_Momentum_NonFerrous_N10_TANH_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'CM_L1_Sector_Precious',
            'file_weights': {
                'Carry_Momentum_Precious_N80_STATE_MACHINE_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'CT_L1_Sector_Agriculture',
            'file_weights': {
                'Carry_TermStructure_Agriculture_N10_ZSCORE_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'CT_L1_Sector_Energy',
            'file_weights': {
                'Carry_TermStructure_Energy_N10_ZSCORE_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'CT_L1_Sector_Ferrous',
            'file_weights': {
                'Carry_TermStructure_Ferrous_N10_STATE_MACHINE_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'CT_L1_Sector_NonFerrous',
            'file_weights': {
                'Carry_TermStructure_NonFerrous_N10_TANH_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'CT_L1_Sector_Precious',
            'file_weights': {
                'Carry_TermStructure_Precious_N10_ZSCORE_norm_Position.csv': 1.0,
            },
        },
        {
            'output_name': 'L2_CarryMomentum_EqualVol',
            'file_weights': {
                'CM_L1_Sector_Agriculture_norm_Position.csv': 1.0,
                'CM_L1_Sector_Energy_norm_Position.csv': 1.0,
                'CM_L1_Sector_Ferrous_norm_Position.csv': 1.0,
                'CM_L1_Sector_NonFerrous_norm_Position.csv': 1.0,
                'CM_L1_Sector_Precious_norm_Position.csv': 0.25,
            },
        },
        {
            'output_name': 'L2_CarryTermStructure_EqualVol',
            'file_weights': {
                'CT_L1_Sector_Agriculture_norm_Position.csv': 1.0,
                'CT_L1_Sector_Energy_norm_Position.csv': 1.0,
                'CT_L1_Sector_Ferrous_norm_Position.csv': 1.0,
                'CT_L1_Sector_NonFerrous_norm_Position.csv': 1.0,
                'CT_L1_Sector_Precious_norm_Position.csv': 0.25,
            },
        },
        {
            'output_name': 'L3_CarryMomentum_vs_CarryTermStructure_EqualVol',
            'file_weights': {
                'L2_CarryMomentum_EqualVol_norm_Position.csv': 1.0,
                'L2_CarryTermStructure_EqualVol_norm_Position.csv': 1.0,
            },
        },
    ]
