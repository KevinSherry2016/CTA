    ...
    tasks = [
        {
            ...
            'file_weights': {
                'TrendMomentum_TimeSeriesMomentum_Agriculture_N40_STATE_MACHINE_norm_Position.csv': 1.0,
                'TrendMomentum_LinearSlope_Agriculture_N50_STATE_MACHINE_norm_Position.csv': 1.0,
            },
        },
        {
        ...
        },
        {
            ...
            'file_weights': {
                'TrendMomentum_AdaptiveBreakoutStrength_Ferrous_N30_ZSCORE_norm_Position.csv': 1.0,
                'TrendMomentum_DonchianChannel_Ferrous_N60_ZSCORE_norm_Position.csv': 1.0,
            },
        },
        {
        ...
        },
        {
            ...
            'file_weights': {
                'TrendMomentum_TimeSeriesMomentum_Precious_N30_STATE_MACHINE_norm_Position.csv': 1.0,
                'TrendMomentum_LinearSlope_Precious_N40_STATE_MACHINE_norm_Position.csv': 1.0,
            },
        },
        {
