# ==============================================================================
# 策略类型：趋势动量复合策略 
# 策略名称：OvernightVsIntraday
# 代表意义：基于隔夜与日内收益率差异的单因子策略。使用状态机模式直接将信号转换为[-1, 1]。
# 适用板块：Ferrous
# ==============================================================================
...
def main():
    ...
    TARGET_SECTORS = ['Ferrous']  # 测试Ferrous板块
    ...
    if results:
        ...
        report_path = os.path.join(output_dir, "OvernightVsIntraday_Ferrous_BacktestResult.csv")
    ...
    if best_positions:
        ...
        pos_path = os.path.join(output_dir, f"OvernightVsIntraday_Position_Ferrous.csv")
