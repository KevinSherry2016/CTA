...
# Factor Name: Microstructure_BuyingSellingPressure
...
FACTOR_NAME = 'Microstructure_BuyingSellingPressure'
...
def _calc_signal(df, n_value):
    ...
    pressure_ma = pressure.rolling(window=n_value).mean()
    return (pressure_ma - 0.5) * 2
