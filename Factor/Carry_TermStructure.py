# ==============================================================================
# Factor Category: TermStructure
# Factor Name: Carry_TermStructure
# Description: carry factor based on main/sub-main spread annualized by tenor gap
# ==============================================================================
...
def _calc_signal(df, n_value):
    ...
    carry = carry.replace([np.inf, -np.inf], np.nan).fillna(0)
    return carry
