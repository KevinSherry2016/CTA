...
# Factor Name: TrendMomentum_LinearSlope
...
FACTOR_NAME = 'TrendMomentum_LinearSlope'
...
def _calc_signal(df, n_value):
    close = df['adj_close']
    return close.rolling(window=n_value).apply(_slope_normalized, raw=True).fillna(0)
