...
# Factor Name: Microstructure_WickImbalance
...
FACTOR_NAME = 'Microstructure_WickImbalance'
...
def _calc_signal(df, n_value):
    ...
    imbalance = (lower_wick - upper_wick) / (high - low + 1e-9)
    return imbalance.rolling(window=n_value).mean().fillna(0)
