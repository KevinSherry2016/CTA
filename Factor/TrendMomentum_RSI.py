...
def main():
    ...
    # 3. 提取日度行情数据
    data = {}
    print(f"正在加载 TrendMomentum_RSI 数据...")
    ...
    print(f"开始计算 TrendMomentum_RSI 因子信号...")
