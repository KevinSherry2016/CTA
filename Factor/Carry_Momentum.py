...
# Factor Name: Carry_Momentum
# Description: momentum of carry term-structure signal
# ==============================================================================
...
def _calc_signal(df, n_value):
    ...
    # Momentum on carry level: positive means carry has been strengthening.
    signal = carry.diff(n_value)
